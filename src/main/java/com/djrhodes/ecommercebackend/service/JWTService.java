...
public class JWTService {
    ...
    /** The key to encrypt the JWTs with. */
    @Value("${jwt.algorithm.key}")
    private String algorithmKey;
    /** The issuer the JWT is signed with. */
    @Value("${jwt.issuer}")
    private String issuer;
    /** How many seconds from generation the JWT should expire.*/
    ...
    /** The JWT claim key for the verification key. */
     ...
     * @return The username stored inside the JWT.
     */
